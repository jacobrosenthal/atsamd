...
pub struct Sets {
    ...
    /// Red Led
    pub led_pin: Pa17<Input<Floating>>,
...
/// Display pins
pub struct Display {
    pub accel_irq: Pb11<Input<Floating>>, // TODO remove once we make miso optional
    pub tft_mosi: Pb12<Input<Floating>>,
    pub tft_sck: Pb13<Input<Floating>>,
    pub tft_reset: Pb2<Input<Floating>>,
    pub tft_cs: Pa4<Input<Floating>>,
    pub tft_dc: Pa5<Input<Floating>>,
    pub tft_backlight: Pa13<Input<Floating>>,
}
...
impl Display {
    ...
    pub fn init(
        ...
        (
            ...
            // b12->a4 tft_cs
            // b5->a5 tft_dc
            // a1->a13 tft_backlight
            ST7735<
                SPIMaster4<
                    hal::sercom::Sercom4Pad3<Pb11<PfD>>,
                    hal::sercom::Sercom4Pad0<Pb12<PfC>>,
    ...
    > {
        ...
        let mut pwm2 = Pwm2::new(
            ...
            1.khz(),
            timer2,
            hal::pwm::TC2Pinout::Pa13(tft_backlight),
            mclk,
        );
